...
/**
 * <p>Clase Java para actualizarProductoReq complex type.
 * 
 ...
 *         &lt;element name="valorDebito" type="{http://www.ABC.com/schemaCanonical}valor"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "actualizarProductoReq", propOrder = {
    "tipoProducto",
    "idProduto",
    "valorDebito"
})
public class ActualizarProductoReq {
    ...
    /**
     * Obtiene el valor de la propiedad valorDebito.
     * 
     */
    ...
    /**
     * Define el valor de la propiedad valorDebito.
     * 
     */
    public void setValorDebito(double value) {
