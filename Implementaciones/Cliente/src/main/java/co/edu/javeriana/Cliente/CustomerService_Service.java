 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://www.ABC.com/CustomerService/", wsdlLocation = "file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Cliente/src/main/resources/co/edu/javeriana/Cliente/wsdl/CustomerService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://www.ABC.com/CustomerService/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Cliente/src/main/resources/co/edu/javeriana/Cliente/wsdl/CustomerService.wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://www.ABC.com/CustomerService/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ABC.com/CustomerService/", "CustomerServicePort"), CustomerService.class, features);
    }
