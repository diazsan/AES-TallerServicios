 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://www.ABC.com/LoginService/", wsdlLocation = "file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Login/src/main/resources/co/edu/javeriana/Login/wsdl/LoginService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://www.ABC.com/LoginService/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Login/src/main/resources/co/edu/javeriana/Login/wsdl/LoginService.wsdl");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://www.ABC.com/LoginService/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ABC.com/LoginService/", "LoginServicePort"), LoginService.class, features);
    }
