 ...
 * 
 */
@WebServiceClient(name = "BillService", targetNamespace = "http://www.ABC.com/BillService/", wsdlLocation = "file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Factura/src/main/resources/co/edu/javeriana/Factura/wsdl/BillService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BILLSERVICE_QNAME = new QName("http://www.ABC.com/BillService/", "BillService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Especializacion/Model_Val_Arquitectura/AES-TallerServicios/Implementaciones/Factura/src/main/resources/co/edu/javeriana/Factura/wsdl/BillService.wsdl");
    ...
    public BillService getBillServicePort() {
        return super.getPort(new QName("http://www.ABC.com/BillService/", "BillServicePort"), BillService.class);
    }
    ...
    public BillService getBillServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ABC.com/BillService/", "BillServicePort"), BillService.class, features);
    }
